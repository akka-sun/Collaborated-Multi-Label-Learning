...
def add_ml_decoder_head(model, num_classes=-1, num_of_groups=-1, decoder_embedding=768, zsl=0):
    ...
    if  hasattr(model, 'fc'):
        del model.fc2
        model.fc2 = MLDecoder(num_classes=num_classes, initial_num_features=num_features, num_of_groups=num_of_groups,
        ...
        model.ml_decoder = MLDecoder(num_classes=num_classes,
