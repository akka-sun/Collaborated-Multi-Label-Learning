...
class FoodDataset(data.Dataset):
    def __init__(self, image_dir, modify_json_dir,ai_json_dir,input_transform=None,type=None):
        self.info = FoodDetection(modify_json=modify_json_dir,ai_json=ai_json_dir, img_folder=image_dir)
        ...
        self.images = []
        l = len(self.info)
        # input_text = [f'This image contains one or more instances of {obj}' for obj in objs]
