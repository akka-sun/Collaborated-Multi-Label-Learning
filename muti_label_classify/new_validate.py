...
data_name='ade20k_gemma' #coco coco_ai ade20k
...
checkpoint_path=f'/root/autodl-tmp/muti_label_classify/output/{data_name}_{data_type}_change/checkpoint_clip-{data_type}_{data_name}_new.pth'
#checkpoint_path = '/root/autodl-tmp/checkpoint_clip-modify_coco_new.pth'
def main():
